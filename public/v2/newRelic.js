...
NREUM.loader_config = {
  accountID: window.ENV.NR_ACCOUNT_ID,
  trustKey: window.ENV.NR_ACCOUNT_ID,
  agentID: window.ENV.NR_APP_ID_REMIX_DDI_CLIENT,
  licenseKey: window.ENV.NR_BROWSER_KEY,
  applicationID: window.ENV.NR_APP_ID_REMIX_DDI_CLIENT,
};
NREUM.info = {
  beacon: "bam.nr-data.net",
  errorBeacon: "bam.nr-data.net",
